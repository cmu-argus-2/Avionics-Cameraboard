...
//248834/1498849/2.50/8/4/Resistor Network
...
(library Library_1
	(padStyleDef "r80_45"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 0.450) (shapeHeight 0.800))
	...
	(patternDef "EXB38V472JV" (originalName "EXB38V472JV")
		(multiLayer
			(pad (padNum 1) (padStyleRef r80_45) (pt -1.200, -0.800) (rotation 0))
			(pad (padNum 2) (padStyleRef r80_45) (pt -0.400, -0.800) (rotation 0))
			(pad (padNum 3) (padStyleRef r80_45) (pt 0.400, -0.800) (rotation 0))
			(pad (padNum 4) (padStyleRef r80_45) (pt 1.200, -0.800) (rotation 0))
			(pad (padNum 5) (padStyleRef r80_45) (pt 1.200, 0.800) (rotation 0))
			(pad (padNum 6) (padStyleRef r80_45) (pt 0.400, 0.800) (rotation 0))
			(pad (padNum 7) (padStyleRef r80_45) (pt -0.400, 0.800) (rotation 0))
			(pad (padNum 8) (padStyleRef r80_45) (pt -1.200, 0.800) (rotation 0))
		)
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.6 2.2) (pt 2.6 2.2) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 2.6 2.2) (pt 2.6 -2.2) (width 0.1))
		)
	...
	(symbolDef "EXB-V8V103JV" (originalName "EXB-V8V103JV")
	...
	(compDef "EXB-V8V103JV" (originalName "EXB-V8V103JV") (compHeader (numPins 8) (numParts 1) (refDesPrefix RN)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "EXB-V8V103JV"))
		(attachedPattern (patternNum 1) (patternName "EXB38V472JV")
			(numPads 8)
			(padPinMap
		...
		(attr "Mouser Part Number" "667-EXB-V8V103JV")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Panasonic/EXB-V8V103JV?qs=uA7cY%2Fh6FfV8sjMUFAyjLA%3D%3D")
		(attr "Manufacturer_Name" "Panasonic")
		(attr "Manufacturer_Part_Number" "EXB-V8V103JV")
		(attr "Description" "Resistor Networks & Arrays 10K OHM 5%")
		(attr "<Hyperlink>" "https://industrial.panasonic.com/cdbs/www-data/pdf/AOC0000/AOC0000C14.pdf")
		(attr "<Component Height>" "0")
		(attr "<STEP Filename>" "EXB-V8V103JV.stp")
